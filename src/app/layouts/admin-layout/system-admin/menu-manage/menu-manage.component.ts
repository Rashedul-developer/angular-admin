        ...
        this.dataService.getJson('system/menu/get', queryString)
            .subscribe(data => {
                    ...
                    if (data.code == 200) {
                        ...
                        this.shiftFrom.forEach(element => {
...
export class CreateMenuManagerAddEditModel {
  ...
  onChanges(values: any): void {
    console.log(values, this.shiftFromValue);
  }
            ...
            .subscribe(data => {
                    ...
                    if (data.code == 200) {
                        ...
                        if(this.languagePrevData.length > 0){
                          this.languagePrevData.forEach(element => {
                            const item = {
                              name: element.title,
                              code: element.locale
                            };
                          ...
                          this.tempLangs.forEach(element => {
                            const item = {
                              name: '',
                              code: element
                            };
